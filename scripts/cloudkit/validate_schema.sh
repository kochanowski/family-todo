...
required_map='{
  ...
  "RecurringChore": ["id", "householdId", "title", "recurrenceType", "recurrenceDay", "recurrenceDayOfMonth", "recurrenceInterval", "defaultAssigneeIds", "defaultAssigneeId", "areaId", "categoryId", "isActive", "scheduleStartDate", "scheduledHour", "scheduledMinute", "lastGeneratedDate", "nextScheduledDate", "notes", "createdAt", "updatedAt"],
